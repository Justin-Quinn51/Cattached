/*
  ...
  - The primary key for the `Breed` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "Breed" DROP CONSTRAINT "Breed_pkey",
